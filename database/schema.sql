...
CREATE TABLE `trx_pekerjaan` (
  ...
  `kepala_opd_nama` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nama Kepala OPD Teknis (diisi OPD sebelum submit ke Inspektorat)',
  `kepala_opd_nip` varchar(18) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'NIP Kepala OPD Teknis',
  `kepala_opd_jabatan` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Jabatan Kepala OPD Teknis',
...
CREATE TABLE `trx_reviu_inspektorat` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tahapan_id` int NOT NULL,
  `tim_id` int DEFAULT NULL COMMENT 'FK → trx_tim_reviu (tim review & surat tugas)',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `trx_tim_reviu_anggota`;
DROP TABLE IF EXISTS `trx_tim_reviu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trx_tim_reviu` (
  `id` int NOT NULL AUTO_INCREMENT,
  `kabkota_id` int NOT NULL,
  `tahun` year NOT NULL,
...
CREATE TABLE `trx_tim_reviu_anggota` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tim_id` int NOT NULL,
...
CREATE TABLE `users` (
  ...
  `consent_at` datetime DEFAULT NULL COMMENT 'Waktu persetujuan penggunaan data pribadi dicentang oleh admin saat membuat akun',
