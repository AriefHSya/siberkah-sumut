...
$route['pekerjaan/kirim-revisi-kab/(:num)']        = 'pekerjaan/kirim_revisi_kab/$1';
...
$route['permohonan/edit/(:num)']                    = 'permohonan/edit/$1';
$route['permohonan/update/(:num)']                  = 'permohonan/update/$1';
